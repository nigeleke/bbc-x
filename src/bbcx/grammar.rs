...
fn mnemonic<'a>() -> Parser<'a, Mnemonic> {
    (exact("DBYTE").map(|_| Mnemonic::DBYTE)
        ...
        | exact("MPLYX").map(|_| Mnemonic::MPLYX)
        | exact("MULTX").map(|_| Mnemonic::MPLYX)
        ...
        | exact("MULT").map(|_| Mnemonic::MPLY)
        ...
        | exact("NILX").map(|_| Mnemonic::SWAP)
        | exact("SWAP").map(|_| Mnemonic::SWAP)
